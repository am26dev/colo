      ...
      <div className="container">
        <div style={{ maxWidth: "46rem", margin: "0 auto", textAlign: "center" }}>
          <Reveal delay={1}>
            ...
            <div style={{ marginTop: "1.75rem", color: "var(--brown)", lineHeight: 1.2 }}>
              <div style={{ fontSize: "0.9rem", fontStyle: "italic" }}>Com carinho,</div>
              <div style={{ marginTop: "0.2rem", fontFamily: "Parisienne, cursive", fontSize: "2.4rem" }}>Winnie</div>
            </div>
          </Reveal>
        </div>
      </div>
